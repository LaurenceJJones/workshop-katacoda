...
In this section of `CrowdSec Parsers and Scenarios for beginners`{{}}, we learned the general structure of the `s01-parse`{{}} parser and how its components fit together.
